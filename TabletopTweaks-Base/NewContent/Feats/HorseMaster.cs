...
namespace TabletopTweaks.Base.NewContent.Feats {
    static class HorseMaster {
        public static void AddHorseMaster() {
            ...
            var ExpertTrainer = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ExpertTrainer", bp => {
                bp.SetName(TTTContext, "Expert Trainer");
                bp.SetDescription(TTTContext, "At 4th level, a cavalier learns to train mounts with speed and unsurpassed expertise.");
            ...
            var HorseMasterRank = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "HorseMasterRank", bp => {
                bp.IsClassFeature = true;
                bp.HideInUI = true;
                bp.Ranks = 20;
                bp.HideInCharacterSheetAndLevelUp = true;
                bp.SetName(TTTContext, "Horse Master Rank");
            ...
            var HorseMaster = Helpers.CreateBlueprint<BlueprintProgression>(TTTContext, "HorseMaster", bp => {
                bp.SetName(TTTContext, "Horse Master");
                bp.SetDescription(TTTContext, "You blend horsemanship skills from disparate traditions into a seamless mounted combat technique.\n" +

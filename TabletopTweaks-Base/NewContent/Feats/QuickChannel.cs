...
namespace TabletopTweaks.Base.NewContent.Feats {
    static class QuickChannel {
        public static void AddQuickChannel() {
            ...
            var QuickChannel = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "QuickChannel", bp => {
                bp.SetName(TTTContext, "Quick Channel");
                bp.SetDescription(TTTContext, "You may channel energy as a move action by spending 2 daily uses of that ability.");
            ...
            if (TTTContext.AddedContent.Feats.IsDisabled("QuickChannel")) { return; }

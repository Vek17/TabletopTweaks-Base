...
namespace TabletopTweaks.Base.NewContent.FighterAdvancedArmorTrainings {
    class ArmorSpecialization {
        public static void AddArmorSpecialization() {
            ...
            var ArmorSpecializationSelection = Helpers.CreateBlueprint<BlueprintFeatureSelection>(TTTContext, "ArmorSpecializationSelection", bp => {
                bp.SetName(TTTContext, "Armor Specialization");
                bp.SetDescription(TTTContext, "The fighter selects one specific type of armor with which he is proficient, such as light or heavy. " +
            ...
            var ArmorSpecializationLightEffect = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmorSpecializationLightEffect", bp => {
                bp.SetName(TTTContext, "Light Armor Specialization");
                bp.SetDescription(TTTContext, "Light Armor Specialization");
                bp.IsClassFeature = true;
            ...
            var ArmorSpecializationLightFeature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmorSpecializationLightFeature", bp => {
            ...
            var ArmorSpecializationMediumEffect = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmorSpecializationMediumEffect", bp => {
                bp.SetName(TTTContext, "Medium Armor Specialization");
                bp.SetDescription(TTTContext, "Medium Armor Specialization");
                bp.IsClassFeature = true;
                bp.HideInCharacterSheetAndLevelUp = true;
                bp.Ranks = 1;
                bp.AddComponent<AddContextStatBonus>(c => {
            ...
            var ArmorSpecializationMediumFeature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmorSpecializationMediumFeature", bp => {
                bp.m_Icon = ArmorFocusLight.Icon;
                bp.SetName(TTTContext, "Medium Armor Specialization");
                bp.SetDescription(TTTContext, "The AC bonus granted by any medium armor " +
            ...
            var ArmorSpecializationHeavyEffect = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmorSpecializationHeavyEffect", bp => {
                bp.SetName(TTTContext, "Heavy Armor Specialization");
                bp.SetDescription(TTTContext, "Heavy Armor Specialization");
                bp.IsClassFeature = true;
                bp.HideInCharacterSheetAndLevelUp = true;
                bp.Ranks = 1;
                bp.AddComponent<AddContextStatBonus>(c => {
            ...
            var ArmorSpecializationHeavyFeature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmorSpecializationHeavyFeature", bp => {
                bp.m_Icon = ArmorFocusLight.Icon;
                bp.SetName(TTTContext, "Heavy Armor Specialization");
                bp.SetDescription(TTTContext, "The AC bonus " +
            ...
            if (TTTContext.AddedContent.FighterAdvancedArmorTraining.IsDisabled("ArmorSpecialization")) { return; }

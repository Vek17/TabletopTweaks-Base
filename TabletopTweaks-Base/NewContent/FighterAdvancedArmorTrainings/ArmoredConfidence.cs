...
namespace TabletopTweaks.Base.NewContent.FighterAdvancedArmorTrainings {
    class ArmoredConfidence {
        public static void AddArmoredConfidence() {
            ...
            var ArmoredConfidenceLightEffect = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmoredConfidenceLightEffect", bp => {
                bp.SetName(TTTContext, "Armored Confidence Effect");
                bp.SetDescription(TTTContext, "Armored Confidence");
            ...
            var ArmoredConfidenceMediumEffect = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmoredConfidenceMediumEffect", bp => {
                bp.SetName(TTTContext, "Armored Confidence Effect");
                bp.SetDescription(TTTContext, "Armored Confidence");
                bp.IsClassFeature = true;
                bp.HideInCharacterSheetAndLevelUp = true;
            ...
            var ArmoredConfidenceHeavyEffect = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmoredConfidenceHeavyEffect", bp => {
                bp.SetName(TTTContext, "Armored Confidence Effect");
                bp.SetDescription(TTTContext, "Armored Confidence");
                bp.IsClassFeature = true;
                bp.HideInCharacterSheetAndLevelUp = true;
            ...
            var ArmoredConfidenceFeature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "ArmoredConfidenceFeature", bp => {
                bp.SetName(TTTContext, "Armored Confidence");
                bp.SetDescription(TTTContext, "While wearing armor, the fighter gains a bonus on Intimidate checks based upon the type of armor he is wearing: " +

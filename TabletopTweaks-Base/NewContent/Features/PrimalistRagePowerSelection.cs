...
namespace TabletopTweaks.Base.NewContent.Features {
    class PrimalistRagePowerSelection {
        public static void AddPrimalistRagePowerSelection() {
            ...
            var PrimalistRagePowerSelection = Helpers.CreateBlueprint<BlueprintFeatureSelection>(TTTContext, "PrimalistRagePowerSelection", bp => {
                bp.SetName(TTTContext, "Primalist Rage Power");
                bp.SetDescription(TTTContext, "At 4th level and every 4 levels thereafter, a primalist can choose to take either his bloodline power "

...
namespace TabletopTweaks.Base.NewContent.Hexes {
    internal class Cauldron {
        public static void AddCauldron() {
            ...
            SylvanTricksterHexSelection.AddFeatures(CauldronHexFeature);
            HexcrafterHexSelection.AddFeatures(CauldronHexFeature);
            HexcrafterArcanaSelection.AddFeatures(CauldronHexFeature);
        }
    }
}

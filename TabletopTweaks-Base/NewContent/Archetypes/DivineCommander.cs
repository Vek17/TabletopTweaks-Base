...
namespace TabletopTweaks.Base.NewContent.Archetypes {
    static class DivineCommander {
        ...
        private static readonly BlueprintFeature TemplateCelestial = BlueprintTools.GetModBlueprint<BlueprintFeature>(TTTContext, "TemplateCelestial");
        private static readonly BlueprintFeature TemplateEntropic = BlueprintTools.GetModBlueprint<BlueprintFeature>(TTTContext, "TemplateEntropic");
        private static readonly BlueprintFeature TemplateFiendish = BlueprintTools.GetModBlueprint<BlueprintFeature>(TTTContext, "TemplateFiendish");
        private static readonly BlueprintFeature TemplateResolute = BlueprintTools.GetModBlueprint<BlueprintFeature>(TTTContext, "TemplateResolute");

        public static void AddDivineCommander() {

            var DivineCommanderArchetype = Helpers.CreateBlueprint<BlueprintArchetype>(TTTContext, "DivineCommanderArchetype", bp => {
                bp.SetName(TTTContext, "Divine Commander");
                bp.SetDescription(TTTContext, "Some warpriests are called to lead great armies and" +
            ...
            var DivineCommanderMobilityFeature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "DivineCommanderMobilityFeature", bp => {
                bp.SetName(TTTContext, "Divine Commander Mobility");
                bp.SetDescription(TTTContext, "A divine commander does not take an armor check penalty on Mobility checks while riding his mount.");
                bp.IsClassFeature = true;
                bp.Ranks = 1;
            ...
            var DivineCommanderAnimalCompanionProgression = Helpers.CreateBlueprint<BlueprintProgression>(TTTContext, "DivineCommanderAnimalCompanionProgression", bp => {
                bp.SetName(TTTContext, "Divine Commander Animal Companion Progression");
            ...
            var DivineCommanderCompanionSelection = Helpers.CreateBlueprint<BlueprintFeatureSelection>(TTTContext, "DivineCommanderCompanionSelection", bp => {
                bp.SetName(TTTContext, "Mount");
                bp.SetDescription(TTTContext, "A divine commander gains the service of a loyal and trusty steed to carry her into battle. This mount functions " +
            ...
            var DivineCommanderBlessedMountCelestial = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "DivineCommanderBlessedMountCelestial", bp => {
                bp.SetName(TTTContext, "Blessed Mount — Celestial");
                bp.SetDescription(TTTContext, "Animal Companion gains spell resistance equal to its level +5. It also gains:\n" +
            ...
            var DivineCommanderBlessedMountEntropic = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "DivineCommanderBlessedMountEntropic", bp => {
                bp.SetName(TTTContext, "Blessed Mount — Entropic");
                bp.SetDescription(TTTContext, "Animal Companion gains spell resistance equal to its level +5. It also gains:\n" +
            ...
            var DivineCommanderBlessedMountFiendish = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "DivineCommanderBlessedMountFiendish", bp => {
                bp.SetName(TTTContext, "Blessed Mount — Fiendish");
                bp.SetDescription(TTTContext, "Animal Companion gains spell resistance equal to its level +5. It also gains:\n" +
            ...
            var DivineCommanderBlessedMountResolute = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "DivineCommanderBlessedMountResolute", bp => {
                bp.SetName(TTTContext, "Blessed Mount — Resolute");
                bp.SetDescription(TTTContext, "Animal Companion gains spell resistance equal to its level +5. It also gains:\n" +
            ...
            var DivineCommanderBlessedMount = Helpers.CreateBlueprint<BlueprintFeatureSelection>(TTTContext, "DivineCommanderBlessedMount", bp => {
                bp.SetName(TTTContext, "Blessed Mount");
                bp.SetDescription(TTTContext, "At 6th level, a divine commander’s mount becomes a creature blessed by his deity. The divine commander’s mount gains either the celestial, " +
            ...
            var DivineCommanderBattleTacticianResource = Helpers.CreateBlueprint<BlueprintAbilityResource>(TTTContext, "DivineCommanderBattleTacticianResource", bp => {
                bp.m_Min = 1;
            ...
            var DivineCommanderBattleTacticianSelection = Helpers.CreateBlueprint<BlueprintFeatureSelection>(TTTContext, "DivineCommanderBattleTacticianSelection", bp => {
                bp.SetName(TTTContext, "Battle Tactician — Bonus Feat");
            ...
            var DivineCommanderBattleTacticianAbility = Helpers.CreateBlueprint<BlueprintAbility>(TTTContext, "DivineCommanderBattleTacticianAbility", bp => {
                bp.SetName(TTTContext, "Battle Tactician");
                bp.SetDescription(TTTContext, "At 3rd level, a divine commander gains a teamwork feat as a bonus feat." +
            ...
            var DivineCommanderBattleTacticianAbilitySwift = Helpers.CreateBlueprint<BlueprintAbility>(TTTContext, "DivineCommanderBattleTacticianAbilitySwift", bp => {
                bp.SetName(TTTContext, "Battle Tactician (Swift)");
                bp.SetDescription(TTTContext, "At 12th level, the divine commander gains an additional teamwork feat as a bonus feat." +
                    " She must meet the prerequisites for this feat." +
            ...
            var DivineCommanderBattleTacticianFeature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "DivineCommanderBattleTacticianFeature", bp => {
                bp.SetName(TTTContext, "Battle Tactician");
                bp.SetDescription(DivineCommanderBattleTacticianAbility.m_Description);
                bp.m_Icon = CavalierTacticianAbility.Icon;
                bp.IsClassFeature = true;
            ...
            var DivineCommanderBattleTacticianGreaterFeature = Helpers.CreateBlueprint<BlueprintFeature>(TTTContext, "DivineCommanderBattleTacticianGreaterFeature", bp => {
                bp.SetName(TTTContext, "Greater Battle Tactician");
            ...
            if (TTTContext.AddedContent.Archetypes.IsDisabled("DivineCommander")) { return; }

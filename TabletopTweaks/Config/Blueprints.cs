...
namespace TabletopTweaks.Config {
    public class Blueprints: IUpdatableSettings {
        ...
        private SortedDictionary<string, string> UsedGUIDs = new SortedDictionary<string, string>();
        [JsonProperty]
        private SortedDictionary<string, string> UnusedGUIDs = new SortedDictionary<string, string>();

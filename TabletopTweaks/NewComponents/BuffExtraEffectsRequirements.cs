...
namespace TabletopTweaks.NewComponents {
    ...
    public class BuffExtraEffectsRequirements : UnitFactComponentDelegate<BuffExtraEffectsRequirements.BuffExtraEffectsData>, IUnitBuffHandler, IGlobalSubscriber, ISubscriber {

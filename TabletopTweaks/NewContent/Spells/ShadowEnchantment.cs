...
namespace TabletopTweaks.NewContent.Spells {
    class ShadowEnchantment {
        public static void AddShadowEnchantment() {
            ...
            var ShadowEnchantment = Helpers.CreateBlueprint<BlueprintAbility>("ShadowEnchantment", (System.Action<BlueprintAbility>)(bp => {
                bp.SetName("Shadow Enchantment");
                ExtentionMethods.SetDescription(bp, (string)("You use material from the Shadow Plane to cast a quasi-real, illusory version of a psychic, sorcerer, or wizard enchantment spell of 2nd level "
        ...
        public static void AddShadowEnchantmentGreater() {
            ...
            var ShadowEnchantmentGreater = Helpers.CreateBlueprint<BlueprintAbility>("ShadowEnchantmentGreater", (System.Action<BlueprintAbility>)(bp => {
                bp.SetName("Shadow Enchantment, Greater");
                ExtentionMethods.SetDescription(bp, (string)("This spell functions like shadow enchantment, except that it enables you to create partially real, illusory versions of psychic, sorcerer, "

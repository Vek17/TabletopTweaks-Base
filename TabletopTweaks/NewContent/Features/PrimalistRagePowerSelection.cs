            ...
            static void AddPrimalistRagePowerSelection() {
                ...
                var PrimalistRagePowerSelection = Helpers.CreateCopy<BlueprintFeatureSelection>(RagePowerSelection, bp => {
                    ...
                    bp.m_Description = Helpers.CreateString(bp.name + ".Description", 
                      "At 4th level and every 4 levels thereafter, a primalist can choose to take either his bloodline power "
                    ...
                    bp.m_DisplayName = Helpers.CreateString(bp.name + ".Name", "Primalist Rage Power");
                });

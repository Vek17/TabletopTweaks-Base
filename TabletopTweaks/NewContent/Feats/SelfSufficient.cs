...
namespace TabletopTweaks.NewContent.Feats {
    static class SelfSufficent {
        public static void AddSelfSufficent() {
            ...
            var SelfSufficent = FeatTools.CreateSkillFeat("Self-Sufficent", StatType.SkillLoreNature, StatType.SkillLoreReligion, (System.Action<Kingmaker.Blueprints.Classes.BlueprintFeature>)(bp => {
                bp.SetName("Self-Sufficent");
                ExtentionMethods.SetDescription(bp, (string)("You know how to get along in the wild and how to effectively treat wounds." +

...
namespace TabletopTweaks.NewContent.Feats {
    static class DervishDance {
        public static void AddDervishDance() {
            ...
            var DervishDance = Helpers.Create<BlueprintFeature>(bp => {
                bp.Ranks = 1;
                bp.ReapplyOnLevelUp = true;
                bp.IsClassFeature = true;
                bp.Groups = new FeatureGroup[] { FeatureGroup.Feat };
                bp.AssetGuid = ModSettings.Blueprints.GetGUID("DervishDance");
                bp.name = "DervishDance";
                bp.SetName("Dervish Dance");
                bp.SetDescriptionTagged("When wielding a scimitar with one hand, you can use your Dexterity modifier instead of your Strength modifier " +

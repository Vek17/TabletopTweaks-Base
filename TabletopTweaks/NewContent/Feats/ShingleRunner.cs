...
namespace TabletopTweaks.NewContent.Feats {
    static class ShingleRunner {
        public static void AddShingleRunner() {
            var ShingleRunner = FeatTools.CreateSkillFeat("ShingleRunner", StatType.SkillAthletics, StatType.SkillMobility, (System.Action<Kingmaker.Blueprints.Classes.BlueprintFeature>)(bp => {
                bp.SetName("Shingle Runner");
                ExtentionMethods.SetDescription(bp, (string)("Many of those who dwell among the rooftops become skillful at making bounding " +

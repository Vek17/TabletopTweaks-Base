    ...
    class FocusedWeapon {
        public static void AddFocusedWeapon() {
            ...
            var FocusedWeaponBuff = Helpers.CreateBuff("FocusedWeaponBuff", bp => {
                bp.SetName("8dc6338de9544fd1939770b27fae2d4e", "Focused Weapon");
                bp.SetDescription("6ac257840aed463392fbcb5467677bcd", "The fighter selects one weapon for which he has Weapon Focus and that belongs to the associated fighter weapon group. " +
            ...
            var FocusedWeaponToggleAbility = Helpers.CreateBlueprint<BlueprintActivatableAbility>("FocusedWeaponToggleAbility", bp => {
                bp.SetName("bd08a1f93cf9404ab0bad5dedc0fc56f", "Focused Weapon");
            ...
            var FocusedWeaponFeature = Helpers.CreateBlueprint<BlueprintParametrizedFeature>("FocusedWeaponFeature", bp => {
                ...
                bp.SetName("8f7e0d0ecc7f4e7b8135f4d87fa8abd3", "Focused Weapon");
                bp.SetDescription(FocusedWeaponBuff.m_Description);

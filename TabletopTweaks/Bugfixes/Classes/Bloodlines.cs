...
namespace TabletopTweaks.Bugfixes.Classes {
    class Bloodlines {
        ...
        public static void patchDragonDisciple() {
            ...
            var excludeBloodline = ScriptableObject.CreateInstance<PrerequisiteNoFeaturesFromList>();
            excludeBloodline.Features = new BlueprintFeatureReference[] {
            ...
            excludeBloodline.Group = Prerequisite.GroupType.Any;

            DragonDiscipleClass.ComponentsArray = DragonDiscipleClass.ComponentsArray
                .Where(c => !(c is PrerequisiteNoFeature))
                .Append(excludeBloodline)
                .ToArray();
        }
    }
}
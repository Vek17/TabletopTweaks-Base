        ...
        static class BlueprintsCache_Init_Patch {
            ...
            static void PatchWitchHexes() {
                ...
                void PatchDeathCurse() {
                    if (ModSettings.Fixes.Witch.Base.IsDisabled("DeathCurse")) { return; }
                ...
                void PatchDeliciousFright() {
                    if (ModSettings.Fixes.Witch.Base.IsDisabled("DeliciousFright")) { return; }
                ...
                void PatchEvilEye() {
                    if (ModSettings.Fixes.Witch.Base.IsDisabled("EvilEye")) { return; }
                ...
                void PatchHoarfrost() {
                    if (ModSettings.Fixes.Witch.Base.IsDisabled("Hoarfrost")) { return; }
                ...
                void PatchRestlessSlumber() {
                    if (ModSettings.Fixes.Witch.Base.IsDisabled("RestlessSlumber")) { return; }
                ...
                void PatchSlumber() {
                    if (ModSettings.Fixes.Witch.Base.IsDisabled("Slumber")) { return; }
                    BlueprintAbility WitchHexSlumberAbility = Resources.GetBlueprint<BlueprintAbility>("630ea63a63457ff4f9de059c578c930a");

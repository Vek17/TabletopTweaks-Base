        ...
        static class ResourcesLibrary_InitializeLibrary_Patch {
            ...
            static void PatchWitchHexes() {
                ...
                void PatchDeathCurse() {
                    if (!ModSettings.Fixes.Witch.Base.Fixes["DeathCurse"]) { return; }
                ...
                void PatchDeliciousFright() {
                    if (!ModSettings.Fixes.Witch.Base.Fixes["DeliciousFright"]) { return; }
                ...
                void PatchEvilEye() {
                    if (!ModSettings.Fixes.Witch.Base.Fixes["EvilEye"]) { return; }
                ...
                void PatchHoarfrost() {
                    if (!ModSettings.Fixes.Witch.Base.Fixes["Hoarfrost"]) { return; }
                ...
                void PatchRestlessSlumber() {
                    if (!ModSettings.Fixes.Witch.Base.Fixes["RestlessSlumber"]) { return; }
                ...
                void PatchSlumber() {
                    if (!ModSettings.Fixes.Witch.Base.Fixes["Slumber"]) { return; }
                    BlueprintAbility WitchHexSlumberAbility = Resources.GetBlueprint<BlueprintAbility>("630ea63a63457ff4f9de059c578c930a");
